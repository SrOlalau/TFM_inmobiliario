...
# Definir las rutas de los modelos, usando separadores compatibles con Windows y Linux
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # Obtiene el directorio base del script actual
MODEL_DIR = os.path.join(BASE_DIR, '..', 'models')
MODEL_ALQUILER_PATH = os.path.join(MODEL_DIR, 'modelo_alquiler.pickle')
MODEL_VENTA_PATH = os.path.join(MODEL_DIR, 'modelo_venta.pickle')
...
# Inicializar el calculador de POIs (con DataFrame en vez de CSV)
